...
let reply (instr: TileInstr list) (score:int)  
    ...
    //It works without doing then forecast
    //but the forecast helps to underline the strange bounce of the ball from the paddle... it inverts its x velocity
    // see also https://www.reddit.com/r/adventofcode/comments/ea9n3f/2019_day_13_part_2_help_with_solution_analysis/
    //let ball =
    ...
    let move : int =
        match paddleMaybe, ballNowMaybe with
        | Some paddle, Some ball ->
